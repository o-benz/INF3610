...
HD_PWD='C:/Temp/code_de_depart_partie2/projet_sol2_2/projet_sol2_2.runs/design_1_axi_timer_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_timer_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_timer_1_0.tcl

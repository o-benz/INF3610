...
HD_PWD='C:/part2/project_sol2/project_sol2.runs/design_proj2_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_proj2_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_proj2_processing_system7_0_0.tcl

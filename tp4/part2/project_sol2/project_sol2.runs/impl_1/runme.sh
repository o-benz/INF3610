...
HD_PWD='C:/part2/project_sol2/project_sol2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_proj2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_proj2_wrapper.tcl -notrace

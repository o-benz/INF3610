...
HD_PWD='C:/part2/project_sol2/project_sol2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_proj2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_proj2_wrapper.tcl

...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("INPUT_STREAM_TDATA", 16, hls_in, 0, "axis", "in_data", 1),
	Port_Property("INPUT_STREAM_TVALID", 1, hls_in, 6, "axis", "in_vld", 1),
	Port_Property("INPUT_STREAM_TREADY", 1, hls_out, 6, "axis", "in_acc", 1),
	Port_Property("INPUT_STREAM_TKEEP", 2, hls_in, 1, "axis", "in_data", 1),
	Port_Property("INPUT_STREAM_TSTRB", 2, hls_in, 2, "axis", "in_data", 1),
	...
	Port_Property("OUTPUT_STREAM_TDATA", 16, hls_out, 7, "axis", "out_data", 1),
	...
	Port_Property("OUTPUT_STREAM_TKEEP", 2, hls_out, 8, "axis", "out_data", 1),
	Port_Property("OUTPUT_STREAM_TSTRB", 2, hls_out, 9, "axis", "out_data", 1),
	Port_Property("OUTPUT_STREAM_TUSER", 4, hls_out, 10, "axis", "out_data", 1),
	Port_Property("OUTPUT_STREAM_TLAST", 1, hls_out, 11, "axis", "out_data", 1),
	Port_Property("OUTPUT_STREAM_TID", 5, hls_out, 12, "axis", "out_data", 1),
	Port_Property("OUTPUT_STREAM_TDEST", 5, hls_out, 13, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "HLS_accel";

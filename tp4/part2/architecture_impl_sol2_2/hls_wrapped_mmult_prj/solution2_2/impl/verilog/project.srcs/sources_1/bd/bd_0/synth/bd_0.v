...
module bd_0
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 INPUT_STREAM " *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME INPUT_STREAM, CLK_DOMAIN bd_0_ap_clk_0, FREQ_HZ 100000000.0, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA xilinx.com:interface:datatypes:1.0 {TDATA {datatype {name {attribs {resolve_type immediate dependency {} format string minimum {} maximum {}} value {}} bitwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 16} bitoffset {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0} integer {signed {attribs {resolve_type immediate dependency {} format bool minimum {} maximum {}} value false}}}} TUSER {datatype {name {attribs {resolve_type immediate dependency {} format string minimum {} maximum {}} value {}} bitwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 4} bitoffset {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0} integer {signed {attribs {resolve_type immediate dependency {} format bool minimum {} maximum {}} value false}}}}}, PHASE 0.000, TDATA_NUM_BYTES 2, TDEST_WIDTH 5, TID_WIDTH 5, TUSER_WIDTH 4" *) input [15:0]INPUT_STREAM_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 INPUT_STREAM " *) input [1:0]INPUT_STREAM_tkeep;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 INPUT_STREAM " *) input [1:0]INPUT_STREAM_tstrb;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 OUTPUT_STREAM " *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME OUTPUT_STREAM, CLK_DOMAIN bd_0_ap_clk_0, FREQ_HZ 100000000.0, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA xilinx.com:interface:datatypes:1.0 {CLK {datatype {name {attribs {resolve_type immediate dependency {} format string minimum {} maximum {}} value {}} bitwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 1} bitoffset {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0}}} TDATA {datatype {name {attribs {resolve_type immediate dependency {} format string minimum {} maximum {}} value {}} bitwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 16} bitoffset {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0} integer {signed {attribs {resolve_type immediate dependency {} format bool minimum {} maximum {}} value false}}}} TDATA_WIDTH 16 TUSER {datatype {name {attribs {resolve_type immediate dependency {} format string minimum {} maximum {}} value {}} bitwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 4} bitoffset {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0} integer {signed {attribs {resolve_type immediate dependency {} format bool minimum {} maximum {}} value false}}}} TUSER_WIDTH 4}, PHASE 0.000, TDATA_NUM_BYTES 2, TDEST_WIDTH 5, TID_WIDTH 5, TUSER_WIDTH 4" *) output [15:0]OUTPUT_STREAM_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 OUTPUT_STREAM " *) output [1:0]OUTPUT_STREAM_tkeep;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 OUTPUT_STREAM " *) output [1:0]OUTPUT_STREAM_tstrb;
  ...
  assign INPUT_STREAM_0_1_TDATA = INPUT_STREAM_tdata[15:0];
  assign INPUT_STREAM_0_1_TDEST = INPUT_STREAM_tdest[4:0];
  assign INPUT_STREAM_0_1_TID = INPUT_STREAM_tid[4:0];
  assign INPUT_STREAM_0_1_TKEEP = INPUT_STREAM_tkeep[1:0];
  assign INPUT_STREAM_0_1_TLAST = INPUT_STREAM_tlast[0];
  assign INPUT_STREAM_0_1_TSTRB = INPUT_STREAM_tstrb[1:0];
  ...
  assign OUTPUT_STREAM_tdata[15:0] = hls_inst_OUTPUT_STREAM_TDATA;
  assign OUTPUT_STREAM_tdest[4:0] = hls_inst_OUTPUT_STREAM_TDEST;
  assign OUTPUT_STREAM_tid[4:0] = hls_inst_OUTPUT_STREAM_TID;
  assign OUTPUT_STREAM_tkeep[1:0] = hls_inst_OUTPUT_STREAM_TKEEP;
  assign OUTPUT_STREAM_tlast[0] = hls_inst_OUTPUT_STREAM_TLAST;
  assign OUTPUT_STREAM_tstrb[1:0] = hls_inst_OUTPUT_STREAM_TSTRB;

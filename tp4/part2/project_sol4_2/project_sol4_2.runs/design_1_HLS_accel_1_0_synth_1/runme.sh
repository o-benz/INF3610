...
HD_PWD='C:/Temp/code_de_depart_partie2/project_sol4_2/project_sol4_2.runs/design_1_HLS_accel_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_HLS_accel_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_HLS_accel_1_0.tcl

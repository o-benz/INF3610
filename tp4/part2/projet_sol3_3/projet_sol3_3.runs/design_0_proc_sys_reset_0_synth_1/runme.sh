...
HD_PWD='C:/Temp/code_de_depart_partie2/projet_sol3_3/projet_sol3_3.runs/design_0_proc_sys_reset_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_0_proc_sys_reset_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_0_proc_sys_reset_0.tcl
